		...
		if node_name then
			if alias_mod then
				if alias_node then
					...
					minetest.register_alias(""..node_mod..":"..node_name.."", ":game:"..node_name.."")
					minetest.register_alias(""..alias_mod..":"..alias_node.."", ":game:"..node_name.."")
			
					minetest.register_alias(node_name, ":game:"..node_name.."")
					minetest.register_alias(alias_node, ":game:"..node_name.."")
			
					--minetest.register_alias(""..alias_mod..":"..alias_node.."", ""..node_mod..":"..node_name.."")
					--minetest.register_alias(":game:"..node_name.."", ""..node_mod..":"..node_name.."")
